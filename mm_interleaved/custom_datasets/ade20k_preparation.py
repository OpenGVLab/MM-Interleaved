...
if __name__ == '__main__':
    ...
    image_dir = os.path.join("./asset/ade20k/ADEChallengeData2016/images", args.split)
    segm_dir = os.path.join("./asset/ade20k/ADEChallengeData2016/annotations", args.split)
    save_dir = os.path.join("./asset/ade20k/ADEChallengeData2016/annotations_with_color", args.split)
